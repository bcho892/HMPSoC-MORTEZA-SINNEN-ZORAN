...
module zoran_nios_mm_interconnect_0 (
	...
	wire   [12:0] cmd_mux_005_src_channel;                                                   // cmd_mux_005:src_channel -> high_res_timer_s1_agent:cp_channel
	...
	wire   [12:0] cmd_mux_006_src_channel;                                                   // cmd_mux_006:src_channel -> BUTTON_pio_s1_agent:cp_channel
	...
	wire  [105:0] cmd_mux_007_src_data;                                                      // cmd_mux_007:src_data -> sseg_0_s1_agent:cp_data
	wire          cmd_mux_007_src_ready;                                                     // sseg_0_s1_agent:cp_ready -> cmd_mux_007:src_ready
	wire   [12:0] cmd_mux_007_src_channel;                                                   // cmd_mux_007:src_channel -> sseg_0_s1_agent:cp_channel
	...
	wire  [105:0] cmd_mux_008_src_data;                                                      // cmd_mux_008:src_data -> sseg_1_s1_agent:cp_data
	wire          cmd_mux_008_src_ready;                                                     // sseg_1_s1_agent:cp_ready -> cmd_mux_008:src_ready
	wire   [12:0] cmd_mux_008_src_channel;                                                   // cmd_mux_008:src_channel -> sseg_1_s1_agent:cp_channel
	...
	wire  [105:0] cmd_mux_009_src_data;                                                      // cmd_mux_009:src_data -> sseg_2_s1_agent:cp_data
	wire          cmd_mux_009_src_ready;                                                     // sseg_2_s1_agent:cp_ready -> cmd_mux_009:src_ready
	wire   [12:0] cmd_mux_009_src_channel;                                                   // cmd_mux_009:src_channel -> sseg_2_s1_agent:cp_channel
	...
	wire  [105:0] cmd_mux_010_src_data;                                                      // cmd_mux_010:src_data -> sseg_3_s1_agent:cp_data
	wire          cmd_mux_010_src_ready;                                                     // sseg_3_s1_agent:cp_ready -> cmd_mux_010:src_ready
	wire   [12:0] cmd_mux_010_src_channel;                                                   // cmd_mux_010:src_channel -> sseg_3_s1_agent:cp_channel
	...
	wire  [105:0] cmd_mux_011_src_data;                                                      // cmd_mux_011:src_data -> sseg_4_s1_agent:cp_data
	wire          cmd_mux_011_src_ready;                                                     // sseg_4_s1_agent:cp_ready -> cmd_mux_011:src_ready
	wire   [12:0] cmd_mux_011_src_channel;                                                   // cmd_mux_011:src_channel -> sseg_4_s1_agent:cp_channel
	...
	wire  [105:0] cmd_mux_012_src_data;                                                      // cmd_mux_012:src_data -> sseg_5_s1_agent:cp_data
	wire          cmd_mux_012_src_ready;                                                     // sseg_5_s1_agent:cp_ready -> cmd_mux_012:src_ready
	wire   [12:0] cmd_mux_012_src_channel;                                                   // cmd_mux_012:src_channel -> sseg_5_s1_agent:cp_channel
	...
	wire  [105:0] sseg_0_s1_agent_rp_data;                                                   // sseg_0_s1_agent:rp_data -> router_009:sink_data
	...
	wire  [105:0] sseg_1_s1_agent_rp_data;                                                   // sseg_1_s1_agent:rp_data -> router_010:sink_data
	...
	wire  [105:0] sseg_2_s1_agent_rp_data;                                                   // sseg_2_s1_agent:rp_data -> router_011:sink_data
	...
	wire  [105:0] sseg_3_s1_agent_rp_data;                                                   // sseg_3_s1_agent:rp_data -> router_012:sink_data
	...
	wire  [105:0] sseg_4_s1_agent_rp_data;                                                   // sseg_4_s1_agent:rp_data -> router_013:sink_data
	...
	wire  [105:0] sseg_5_s1_agent_rp_data;                                                   // sseg_5_s1_agent:rp_data -> router_014:sink_data
